...
To add **DocumentDetector 16.4.1** to your project using **Swift Package Manager**:
...
4. Select the version `16.4.1` or choose "Up to Next Major" option to ensure that your project will automatically get future compatible updates.
